...
#camconfig="ne30_g16"
#camconfig="mp120a_g16"
camconfig="ne0conus30x8_t12.exp003"
#camconfig="mp15a-120a-US_t12.exp004"
arr=(/glade2/h2/acgd0005/archive/f.asd2017.cesm20b05.FAMIPC6CLM5.${camconfig}/atm/hist/f.asd2017.cesm20b05.FAMIPC6CLM5.${camconfig}.cam.h2.19*nc)
